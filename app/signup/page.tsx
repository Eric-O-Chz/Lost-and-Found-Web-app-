...
const SignUp02Page = () => {
  ...
  const [formState, formAction] = useActionState(register,{success:false,errors:{}})
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="max-w-sm w-full flex flex-col items-center border rounded-lg p-6 shadow-sm">
        ...
        <p className="mt-4 text-2xl font-bold tracking-tight text-gray-600 text-center">
         Don&rsquo;t have an account?<br /> <strong>Create One</strong>
        </p>
        ...
        <div className="my-7 w-full flex items-center justify-center overflow-hidden">
          ...
          <form
            className="w-full space-y-4" action={formAction} noValidate
          >
           <div>
            <Input name="email" autoComplete="off" type="email" placeholder="Email" />
